...
class UnitreeActuator(DelayedPDActuator):
    ...
    armature: torch.Tensor # motor inertia
    ...
    def compute(
        ...
        control_action = super().compute(control_action, joint_pos, joint_vel) # use the _clip_effort to clip effort
        ...
        control_action.joint_efforts = self.applied_effort # Only torque
